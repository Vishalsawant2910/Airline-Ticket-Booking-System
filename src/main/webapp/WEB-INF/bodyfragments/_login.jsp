        ...
        <sf:form method="post"
					...
					<div class="user-box" >
								<s:bind path="login">
									...
									<sf:input type="text"  path="${status.expression}" style="text-align:center" required=""/>
									 <sf:errors
							...
							<br>
								...
								<s:bind path="password">
									...
									<sf:input type="password" path="${status.expression}" style="text-align:center" required=""/>
									 <sf:errors path="${status.expression}"/> 
									 <label  for="pwd" style="text-align:center">PASSWORD</label>
								</s:bind>
							</div>
               ...
               <span></span>
                ...
                <span></span> 
                	...
                	<input type="submit"  name="operation" 
							class="btn btn-outline-info"	value="SignIn">
            </p>
        </sf:form>
    </div>
